...
![Категории знаний с политикой эмбеддинга](images/knowledge-categories.png)

![Документ базы знаний: содержимое, политика, кнопка «Проиндексировать»](images/knowledge-base-item.png)
...
маршрут доверенным в карточке модели. Если режим модели-эмбеддера «Блокировать», фрагменты
