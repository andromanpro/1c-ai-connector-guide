...
> **Замеры производительности «внутренний vs внешний»** на репрезентативной базе — в планах
> (нужен прогон на реальных объёмах). Ориентир для внутреннего: линейный перебор, порог
> «менее секунды» — сотни фрагментов; за этой границей выигрывает Qdrant.
