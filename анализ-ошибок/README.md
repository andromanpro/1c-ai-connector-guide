...
## Персональные данные в уведомлениях

Текст ошибки, имя пользователя и разбор ИИ перед отправкой в Telegram проходят
**[контроль персональных данных](../контроль-персональных-данных/README.md)**: по умолчанию ФИО,
ИНН, телефоны и почта заменяются подстановками. Разбор ИИ в журнале мониторинга тоже хранится
с подстановками — модель их и видела.
