...
режим «Логировать»: код уходит как есть, находки пишутся в журнал. Если Kroki публичный, выберите
«Маскировать» — подписи заменятся подстановками, а в SVG на форме вернутся исходные (в PNG
